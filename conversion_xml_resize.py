...
def resize_boxes(boxes, orig_size, target_width):
    ...
    scale_y = scale_x  # Mantendo a proporção da altura
...
# Exemplo de uso
input_folder = "Train\Annotations-3"  # Substitua pelo caminho correto
output_folder = "Train\Annotations-3-720"  # Substitua pelo caminho correto
